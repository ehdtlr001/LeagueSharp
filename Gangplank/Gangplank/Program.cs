...
namespace Gangplank
{
    class Program
    {
        ...
        private static void MenuIni()
        {
            ...
            // Cleanser W,QSS Manager Menu
            var cleanserManagerMenu = new Menu("W,QSS cleanser", "gangplank.menu.misc.cleansermanager");
            ...
            potionManagerMenu.AddItem(new MenuItem("gangplank.menu.item.potion.mp", "Mana Potion").SetValue(true));
            potionManagerMenu.AddItem(new MenuItem("gangplank.menu.item.potion.mana", "Mana %").SetTooltip("If under, will use Mana potion").SetValue(new Slider(30)));
        ...
        private static void Potion()
        {
            ...
            if (GetBool("gangplank.menu.item.potion.mp") &&
                Player.ManaPercent <= Getslider("gangplank.menu.item.potion.mana") &&
                Items.HasItem(2004))
            {
